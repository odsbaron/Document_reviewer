...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="Review documents for logic issues and inside-knowledge risk.",
    )
    ...
    key_parser = subparsers.add_parser("store-key", help="Store AIHubMix API key in system keyring.")
...
def _store_key(args: argparse.Namespace) -> int:
    ...
    api_key = args.key or getpass.getpass("AIHubMix API key: ")
